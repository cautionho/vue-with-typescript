<template>
  <Col>
    <Button type="primary" @click="Trigger">取消FLS包裹单</Button>
  </Col>
</template>
<script lang="ts">
...
export default class CancelFLS extends Vue {
      ...
      Callback:(B:boolean):void => {
        if(B){
          ...
          this.$Request.Post({
            ...
            Api: {
              Address: this.$Api.CancelFlsShipOrder,
              Login:true
            },
            ...
            Callback: (Res:PInterface.Res):void => {
              ...
              if(Res.IsSuccess){
                this.$UI.Tips.Floating('success','取消FLS包裹单成功')
